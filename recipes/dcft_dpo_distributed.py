...
class DCFTDPORecipeDistributed(FTRecipeInterface):
    """
    ...
    def setup(self, cfg: DictConfig) -> None:
        ...
        self.ignore_labels_cache = torch.full(
            (cfg.batch_size, 1), CROSS_ENTROPY_IGNORE_IDX, device=self._device
        )
...
def recipe_main(cfg: DictConfig) -> None:
    ...
    config.log_config(recipe_name="DCFTDPORecipeDistributed", cfg=cfg)

    recipe = DCFTDPORecipeDistributed(cfg=cfg)
